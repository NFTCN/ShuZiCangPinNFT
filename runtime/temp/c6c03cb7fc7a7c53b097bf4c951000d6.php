<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"/www/wwwroot/www.masart.top/public/../application/admin/view/nft/collection/add.html";i:1650339578;s:70:"/www/wwwroot/www.masart.top/application/admin/view/layout/default.html";i:1650339576;s:67:"/www/wwwroot/www.masart.top/application/admin/view/common/meta.html";i:1650339578;s:69:"/www/wwwroot/www.masart.top/application/admin/view/common/script.html";i:1650339578;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-author_id" min="0" data-rule="required" data-source="nft.author/index" class="form-control selectpage" name="row[author_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Issuer_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-issuer_id" data-rule="required" data-source="nft.issuer/index" class="form-control selectpage" name="row[issuer_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Category_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" data-rule="required" data-source="nft.category/selectpage" data-params='{"custom[type]":"series","custom[pid]":"0"}' class="form-control selectpage" name="row[category_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-tag" class="form-control" name="row[tag]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Image'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo Form::image('row[image]', '', ['data-rule'=>'required','data-tip'=>'请最少上传800 * 800的资源']); ?>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Master image'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo Form::image('row[master_image]', '', ['data-rule'=>'required']); ?>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('藏品配色'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo Form::input('text','row[text_color]', '', ['data-rule'=>'required','placeholder'=>'格式例如:#99999']); ?>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Description'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo Form::textarea('row[description]', '', ['data-rule'=>'required','rows'=>10]); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-pay_limit" class="form-control" name="row[pay_limit]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[state]-<?php echo $key; ?>"><input id="row[state]-<?php echo $key; ?>" name="row[state]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"0"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
