...
(function(){
	...
	var // jQuery and jQueryUI version
		...
		start = function(elFinder, editors, config) {
			// load jQueryUI CSS
			elFinder.prototype.loadCss('//cdn.bootcdn.net/ajax/libs/jqueryui/'+uiver+'/themes/smoothness/jquery-ui.css');
	...
	require.config({
		baseUrl : 'js',
		paths : {
			'jquery'   : '//cdn.bootcdn.net/ajax/libs/jquery/'+(ie8? '1.12.4' : jqver)+'/jquery.min',
			'jquery-ui': '//cdn.bootcdn.net/ajax/libs/jqueryui/'+uiver+'/jquery-ui.min',
