...
elFinder.prototype._options = {
	...
	cdns : {
		// for editor etc.
		ace        : '//cdn.bootcdn.net/ajax/libs/ace/1.3.3',
		codemirror : '//cdn.bootcdn.net/ajax/libs/codemirror/5.37.0',
		ckeditor   : '//cdn.bootcdn.net/ajax/libs/ckeditor/4.9.2',
		ckeditor5  : '//cdn.ckeditor.com/ckeditor5/10.0.0',
		tinymce    : '//cdn.bootcdn.net/ajax/libs/tinymce/4.7.11',
		simplemde  : '//cdn.bootcdn.net/ajax/libs/simplemde/1.11.2',
		// for quicklook etc.
		hls        : '//cdn.bootcdn.net/ajax/libs/hls.js/0.9.1/hls.min.js',
		dash       : '//cdn.bootcdn.net/ajax/libs/dashjs/2.6.7/dash.all.min.js',
		flv        : '//cdn.bootcdn.net/ajax/libs/flv.js/1.4.2/flv.min.js',
		prettify   : '//cdn.rawgit.com/google/code-prettify/fbd527e9f76914e36f730ec9849f2115473a65d8/loader/run_prettify.js',
		psd        : '//cdn.bootcdn.net/ajax/libs/psd.js/3.2.0/psd.min.js',
		...
		marked     : '//cdn.bootcdn.net/ajax/libs/marked/0.3.19/marked.min.js',
		sparkmd5   : '//cdn.bootcdn.net/ajax/libs/spark-md5/3.0.0/spark-md5.min.js',
		jssha      : '//cdn.bootcdn.net/ajax/libs/jsSHA/2.3.1/sha.js',
